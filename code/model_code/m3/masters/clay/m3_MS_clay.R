...
rm(list=ls())
setwd("~/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/gorgi_reg_nosurf/master/master_clay")
...
#saving outputs
save(out,model.data,run_time,file = "gorgi_model_reg_nosurf_output_MS_clay_stand_pred_noht_noage_out.RData")
...
for (i in 1:8){
  ...
  save(out,model.data,file = "gorgi_reg_nosurf_MS_clay_with_extra_burnin_stand_pred_noht_noage.RData")
  print(i)
}
t21 <- Sys.time()
run_time_2 <- t21-t11
save(out,model.data,run_time_2,file = "gorgi_reg_nosurf_MS_clay_with_extra_burnin_stand_pred_noht_noage.RData")
#===========================================================================================================

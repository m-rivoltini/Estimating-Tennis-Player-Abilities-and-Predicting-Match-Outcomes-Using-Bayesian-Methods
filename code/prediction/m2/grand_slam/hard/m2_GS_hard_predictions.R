...
setwd("~/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Predictions/gorgi_noreg_nosurf/grand_slam/grand_slam_hard")

#loading data sets
atp_matches_2000_train <- read.csv2(file = "atp_matches_2000_train_GS_hard.csv",header = TRUE)
atp_players_2000_train <- read.csv2(file = "atp_players_2000_train_GS_hard.csv",header = TRUE)
...
atp_matches_2000_train_test <- read.csv2(file = "atp_matches_2000_train_test_GS_hard.csv",header = TRUE)
atp_players_2000_train_test <- read.csv2(file = "atp_players_2000_train_test_GS_hard.csv",header = TRUE)
...
#loading the outputs of the M2_GS_hard
load("/Volumes/SanDisk SSD/Model_fitting_V2/gorgi_noreg_nosurf/grand_slam/grand_slam_hard/gorgi_no_reg_nosurf_GS_hard_with_extra_burnin.RData")

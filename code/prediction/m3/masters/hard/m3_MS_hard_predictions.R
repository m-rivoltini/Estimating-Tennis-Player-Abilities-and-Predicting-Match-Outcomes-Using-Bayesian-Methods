#This script file performs the predictions for out-of-sample matches for M3 on clay surface (Masters Tour)
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Predictions/gorgi_reg_nosurf/master/master_hard")
...
#loading the outputs 
load("/Volumes/SanDisk SSD/Model_fitting_V2/gorgi_reg_nosurf/master/master_hard/gorgi_reg_nosurf_MS_hard_with_extra_burnin_stand_pred_noht_noage.RData")

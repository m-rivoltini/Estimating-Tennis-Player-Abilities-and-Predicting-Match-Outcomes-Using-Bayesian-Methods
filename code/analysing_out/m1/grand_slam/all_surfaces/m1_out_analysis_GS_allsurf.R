#=========== Analysing the output of M1 fitted on the Grand Slam tour combining all surfaces ===========
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Analysing_model_fit_outputs/fixed_time_bt/grand_slam/grand_slam_allsurf")

#loading all files and getting computation times for each run
load(file = "/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_allsurf/BT_fixed_time_out_GS_allsurf.RData")
run_time

load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_allsurf/BT_fixed_time_out_GS_allsurf_with_extra_burnin_small_iter_no_thin.RData")
run_time_2

load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_allsurf/BT_fixed_time_out_GS_allsurf_with_extra_burnin.RData")
run_time_2

load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_allsurf/BT_fixed_time_out_GS_allsurf_with_extra_burnin_2.RData")
run_time_2

load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_allsurf/BT_fixed_time_out_GS_allsurf_with_extra_burnin_3.RData")
run_time_2

#loading the data sets
atp_matches_2000_train <- read.csv2("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_allsurf/atp_matches_2000_train_GS_allsurf.csv")

atp_players_2000_train <- read.csv2("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_allsurf/atp_players_2000_train_GS_allsurf.csv")
...
player_names_opponents <- c(atp_players_2000_train$name,paste(atp_matches_2000_train$player_i_name,"vs",atp_matches_2000_train$player_j_name),"NA") #NA here is for the deviance
...
#saving the summaries
write.csv(summaries,file = "BT_GS_allsurf_summaries.csv")

#getting the run times of the models
run_time 
run_time_2
...
top_15_player_names <- atp_matches_2000_train$winner_name[match(top_15_players_ID, atp_matches_2000_train$winner_id)] 
...
#plotting the traceplots, posteriors, acfs and gelman plots for all players and saving them as pdfs

pdf("M1_GS_allsurf_lambda_trace_plots.pdf")
par(mfrow = c(3,1))
...
pdf("M1_GS_allsurf_lambda_density_plots.pdf")
par(mfrow = c(3,3))
for (i in 1:nrow(atp_players_2000_train)){
  jagsUI::densityplot(out,parameters  = paste("lambda[",i,"]",sep = ""))
  mtext(as.character(atp_players_2000_train$name[i]),side = 3,cex = 0.6)
}
dev.off()

#plotting the traceplots and posteriors for top players
pdf("M1_GS_allsurf_p_ij_trace_plots.pdf")
par(mfrow = c(3,1))
for (i in 1:nrow(atp_matches_2000_train)){
  jagsUI::traceplot(out,parameters  = paste("p[",i,"]",sep = ""))
  mtext(paste(as.character(atp_matches_2000_train$player_i_name[i]),"vs",as.character(atp_matches_2000_train$player_j_name[i])),side = 3,cex = 1.2)
}
dev.off()

pdf("M1_GS_allsurf_p_ij_density_plots.pdf")
par(mfrow = c(3,3))
for (i in 1:nrow(atp_matches_2000_train)){
  jagsUI::densityplot(out,parameters  = paste("p[",i,"]",sep = ""))
  mtext(paste(as.character(atp_matches_2000_train$player_i_name[i]),"vs",as.character(atp_matches_2000_train$player_j_name[i])),side = 3,cex = 0.6)
}
dev.off()

pdf("M1_GS_allsurf_lambda_acf_plots.pdf")
par(mfrow = c(3,3))
for (i in 1:nrow(atp_players_2000_train)){
  acf(out$sims.list$lambda[,i],main = as.character(atp_players_2000_train$name[i]))
}
dev.off()

pdf("M1_GS_allsurf_p_ij_acf_plots.pdf")
par(mfrow = c(3,3))
for (i in 1:nrow(atp_matches_2000_train)){
...
pdf("M1_GS_allsurf_lambda_gelman_plots.pdf")
#par(mfrow = c(3,3))
for (i in 1:nrow(atp_players_2000_train)){
...
pdf("M1_GS_allsurf_p_ij_gelman_plots.pdf")
#par(mfrow = c(3,3))
for (i in 1:nrow(atp_matches_2000_train)){

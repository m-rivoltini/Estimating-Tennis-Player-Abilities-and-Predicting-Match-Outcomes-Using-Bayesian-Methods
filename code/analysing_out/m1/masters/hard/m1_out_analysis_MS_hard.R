#=========== Analysing the output of M1 fitted on the Grand Slam tour on hard surface ===========
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Analysing_model_fit_outputs/fixed_time_bt/master/master_hard")

#loading all files and getting computation times for each run
load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/master/master_hard/BT_fixed_time_out_MS_hard.RData")
run_time

load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/master/master_hard/BT_fixed_time_out_MS_hard_with_extra_burnin_small_iter_no_thin.RData")
run_time_2

load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/master/master_hard/BT_fixed_time_out_MS_hard_with_extra_burnin.RData")
run_time_2

load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/master/master_hard/BT_fixed_time_out_MS_hard_with_extra_burnin_2.RData")
run_time_2

#loading the data sets
atp_matches_2000 <- read.csv2("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/master/master_hard/atp_matches_2000_train_MS_hard.csv")

atp_players_2000 <- read.csv2("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/master/master_hard/atp_players_2000_train_MS_hard.csv")
...
#saving summaries
write.csv(summaries,file = "BT_MS_hard_summaries.csv")
...
pdf("M1_MS_hard_lambda_trace_plots.pdf")
par(mfrow = c(3,1))
...
pdf("M1_MS_hard_lambda_density_plots.pdf")
par(mfrow = c(3,3))
for (i in 1:nrow(atp_players_2000)){
...
pdf("M1_MS_hard_p_ij_trace_plots.pdf")
par(mfrow = c(3,1))
...
pdf("M1_MS_hard_p_ij_density_plots.pdf")
par(mfrow = c(3,3))
for (i in 1:nrow(atp_matches_2000)){
...
pdf("M1_MS_hard_lambda_acf_plots.pdf")
par(mfrow = c(3,3))
for (i in 1:nrow(atp_players_2000)){
...
pdf("M1_MS_hard_p_ij_acf_plots.pdf")
par(mfrow = c(3,3))
for (i in 1:nrow(atp_matches_2000)){
...
pdf("M1_MS_hard_lambda_gelman_plots.pdf")
#par(mfrow = c(3,3))
for (i in 1:nrow(atp_players_2000)){
...
pdf("M1_MS_hard_p_ij_gelman_plots.pdf")
#par(mfrow = c(3,3))
for (i in 1:nrow(atp_matches_2000)){

#This script file performs the predictions for out-of-sample matches for M2 on clay surface (Masters Tour)
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Predictions/gorgi_noreg_nosurf/master/master_clay")

#loading data sets
atp_matches_2000_train <- read.csv2(file = "atp_matches_2000_train_MS_clay.csv",header = TRUE)
atp_players_2000_train <- read.csv2(file = "atp_players_2000_train_MS_clay.csv",header = TRUE)
...
atp_matches_2000_train_test <- read.csv2(file = "atp_matches_2000_train_test_MS_clay.csv",header = TRUE)
atp_players_2000_train_test <- read.csv2(file = "atp_players_2000_train_test_MS_clay.csv",header = TRUE)
...
#loading the outputs of the M2 on clay (Masters Tour)
load("/Volumes/SanDisk SSD/Model_fitting_V2/gorgi_noreg_nosurf/master/master_clay/gorgi_no_reg_nosurf_MS_clay_with_extra_burnin.RData")

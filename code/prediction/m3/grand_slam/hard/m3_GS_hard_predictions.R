#This script file performs the predictions for out-of-sample matches for M3 on hard surface (Grand Slam Tour)
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Predictions/gorgi_reg_nosurf/grand_slam/grand_slam_hard")
...
#loading the outputs
load("/Volumes/SanDisk SSD/Model_fitting_V2/gorgi_reg_nosurf/grand_slam/grand_slam_hard/gorgi_reg_nosurf_GS_hard_with_extra_burnin_stand_pred_noht_noage.RData")

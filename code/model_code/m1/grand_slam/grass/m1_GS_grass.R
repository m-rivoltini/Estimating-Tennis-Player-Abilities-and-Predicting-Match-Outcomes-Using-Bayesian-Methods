#======= This script file runs M1 on the grass surface for the Grand Slam Tour ===========

rm(list=ls()) #clearing environment
setwd("~/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_grass")
...
#importing the data
atp_matches_2000_BT <- read.csv2("atp_matches_2000_train_GS_grass.csv",header = TRUE)
atp_players_2000_BT <- read.csv2("atp_players_2000_train_GS_grass.csv",header = TRUE)
...
t2 <- Sys.time()
run_time <- t2-t1
save(out,model.data,run_time,file = "BT_fixed_time_out_GS_grass.RData")
...
t11 <- Sys.time() #used to get the run time of the model
#for (i in 1:8){
  out <- update(out,parameters.to.save = parms, n.iter = 50000,n.thin = 10)
  save(out,model.data,file = "BT_fixed_time_out_GS_grass_with_extra_burnin_7.RData")
 # print(i)
#}
t21 <- Sys.time()
run_time_2 <- t21-t11
save(out,model.data,run_time_2,file = "BT_fixed_time_out_GS_grass_with_extra_burnin_7.RData")
#===========================================================================================================
#This script file performs the predictions for out-of-sample matches for M3 on clay surface (Grand Slam Tour)
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Predictions/gorgi_reg_nosurf/grand_slam/grand_slam_clay")
...
#loading the outputs 
load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/gorgi_reg_nosurf/grand_slam/grand_slam_clay/gorgi_reg_nosurf_GS_clay_with_extra_burnin_stand_pred_noht_noage.RData")

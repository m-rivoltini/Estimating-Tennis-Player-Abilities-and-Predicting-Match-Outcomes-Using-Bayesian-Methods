#This script file performs the predictions for out-of-sample matches for M1 on clay surface (Masters Tour)
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Predictions/fixed_time_bt/master/master_clay")
...
#loading the outputs of the BT_MS_clay

#This script file performs the predictions for out-of-sample matches for M1 on combined surfaces (Grand Slam Tour)
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Predictions/fixed_time_bt/grand_slam/grand_slam_allsurf")

#loading data sets
atp_matches_2000_train <- read.csv2(file = "atp_matches_2000_train_GS_allsurf.csv",header = TRUE)
atp_players_2000_train <- read.csv2(file = "atp_players_2000_train_GS_allsurf.csv",header = TRUE)
...
atp_matches_2000_train_test <- read.csv2(file = "atp_matches_2000_train_test_GS_allsurf.csv",header = TRUE)
atp_players_2000_train_test <- read.csv2(file = "atp_players_2000_train_test_GS_allsurf.csv",header = TRUE)
...
#loading the outputs of the BT_GS_allsurf
...
atp_matches_2000_test$y_pred <- as.factor(y_pred)
atp_matches_2000_test$y_pred_2 <- as.factor(y_pred_2)

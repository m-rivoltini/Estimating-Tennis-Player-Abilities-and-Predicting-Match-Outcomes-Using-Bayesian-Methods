#This script file performs the predictions for out-of-sample matches for M1 on hard surfaces (Grand Slam Tour)
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Predictions/fixed_time_bt/grand_slam/grand_slam_hard")
...
#loading the outputs of the BT_GS_hard

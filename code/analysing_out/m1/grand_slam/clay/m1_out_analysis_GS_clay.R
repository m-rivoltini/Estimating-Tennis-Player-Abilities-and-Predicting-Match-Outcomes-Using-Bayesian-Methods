#=========== Analysing the output of M1 fitted on the Grand Slam tour on the clay surface ===========
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Analysing_model_fit_outputs/fixed_time_bt/grand_slam/grand_slam_clay")

#loading all files and getting computation times for each run
load(file = "/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_clay/BT_fixed_time_out_GS_clay.RData")
run_time

load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_clay/BT_fixed_time_out_GS_clay_with_extra_burnin_small_iter_no_thin.RData")
run_time_2

load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_clay/BT_fixed_time_out_GS_clay_with_extra_burnin.RData")
run_time_2

load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_clay/BT_fixed_time_out_GS_clay_with_extra_burnin_2.RData")
run_time_2

load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_clay/BT_fixed_time_out_GS_clay_with_extra_burnin_3.RData")
run_time_2

load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_clay/BT_fixed_time_out_GS_clay_with_extra_burnin_4.RData")
run_time_2

load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_clay/BT_fixed_time_out_GS_clay_with_extra_burnin_5_n5000_thin_5.RData")
run_time_2
...
atp_matches_2000 <- read.csv2("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_clay/atp_matches_2000_train_GS_clay.csv")

atp_players_2000 <- read.csv2("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_clay/atp_players_2000_train_GS_clay.csv")
...
pdf("M1_GS_clay_lambda_trace_plots.pdf")
par(mfrow = c(3,1))
...
pdf("M1_GS_clay_lambda_density_plots.pdf")
par(mfrow = c(3,3))
for (i in 1:nrow(atp_players_2000)){
...
pdf("M1_GS_clay_p_ij_trace_plots.pdf")
par(mfrow = c(3,1))
for (i in 1:nrow(atp_matches_2000)){
  jagsUI::traceplot(out,parameters  = paste("p[",i,"]",sep = ""))
  mtext(paste(as.character(atp_matches_200$player_i_name[i]),"vs",as.character(atp_matches_2000$player_j_name[i])),side = 3,cex = 1.2)
}
dev.off()

pdf("M1_GS_clay_p_ij_density_plots.pdf")
par(mfrow = c(3,3))
for (i in 1:nrow(atp_matches_2000)){
...
pdf("M1_GS_clay_lambda_acf_plots.pdf")
par(mfrow = c(3,3))
for (i in 1:nrow(atp_players_2000)){
...
pdf("M1_GS_clay_p_ij_acf_plots.pdf")
par(mfrow = c(3,3))
for (i in 1:nrow(atp_matches_2000)){
...
pdf("M1_GS_clay_lambda_gelman_plots.pdf")
#par(mfrow = c(3,3))
for (i in 1:nrow(atp_players_2000)){
...
pdf("M1_GS_clay_p_ij_gelman_plots.pdf")
#par(mfrow = c(3,3))
for (i in 1:nrow(atp_matches_2000)){

# ================= Analysing outputs of M3 applied to the clay data set for Grand Slam ===========
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Analysing_model_fit_outputs/gorgi_reg_nosurf/grand_slam/grand_slam_clay")

#loading outputs and obtained run times for each compilation
load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/gorgi_reg_nosurf/grand_slam/grand_slam_clay/gorgi_model_reg_nosurf_output_GS_clay_stand_pred_noht_noage_out.RData")
run_time

load(file = "/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/gorgi_reg_nosurf/grand_slam/grand_slam_clay/gorgi_reg_nosurf_GS_clay_with_extra_burnin_stand_pred_noht_noage.RData")
run_time_2

#importing data 
atp_matches_2000_train <- read.csv2("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/gorgi_reg_nosurf/grand_slam/grand_slam_clay/atp_matches_2000_train_GS_clay.csv")

atp_players_2000_train <- read.csv2("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/gorgi_reg_nosurf/grand_slam/grand_slam_clay/atp_players_2000_train_GS_clay.csv")
...
#saving summaries
write.csv(summaries,file = "M3_GS_clay_summaries.csv")
...
pdf("M3_GS_clay_seq_plots_lambda_top_players_ordered.pdf")
par(mfrow = c(3,1))
for (k in 1:nrow(atp_players_2000_train)){
...
pdf("M3_GS_clay_seq_plots_lambda.pdf")
par(mfrow = c(3,1))
for (k in 1:nrow(atp_players_2000_train)){
...
pdf("M3_GS_clay_lambda_trace_plots.pdf")
par(mfrow = c(3,1))
...
pdf("M3_GS_clay_lambda_density_plots.pdf")
par(mfrow = c(3,3))
for (t in 1:nrow(atp_matches_2000_train)){
  for (i in 1:nrow(atp_players_2000_train)){
...
pdf("M3_GS_clay_lambda_tilde_trace_plots.pdf")
par(mfrow = c(3,1))
for (t in 1:nrow(atp_matches_2000_train)){
  for (i in 1:nrow(atp_players_2000_train)){
...
pdf("M3_GS_clay_lambda_tilde_density_plots.pdf")
par(mfrow = c(3,3))
for (t in 1:nrow(atp_matches_2000_train)){
  for (i in 1:nrow(atp_players_2000_train)){
...
pdf("M3_GS_clay_p_ij_trace_plots.pdf")
par(mfrow = c(3,1))
for (t in 1:nrow(atp_matches_2000_train)){
...
pdf("M3_GS_clay_p_ij_density_plots.pdf")
par(mfrow = c(3,3))
for (t in 1:nrow(atp_matches_2000_train)){
...
pdf("M3_GS_clay_lambda_acf_plots.pdf")
par(mfrow = c(3,3))
for (t in 1:nrow(atp_matches_2000_train)){
  for (i in 1:nrow(atp_players_2000_train)){
...
pdf("M3_GS_clay_lambda_tilde_acf_plots.pdf")
par(mfrow = c(3,3))
for (t in 1:nrow(atp_matches_2000_train)){
  for (i in 1:nrow(atp_players_2000_train)){
...
pdf("M3_GS_clay_p_ij_acf_plots.pdf")
par(mfrow = c(3,3))
for (t in 1:nrow(atp_matches_2000_train)){
...
pdf("M3_GS_clay_lambda_gelman_plots.pdf")
#par(mfrow = c(3,3))
for (t in 1:nrow(atp_matches_2000_train)){
  for (i in 1:nrow(atp_players_2000_train)){
...
pdf("M3_GS_clay_lambda_tilde_gelman_plots.pdf")
#par(mfrow = c(3,3))
for (t in 1:nrow(atp_matches_2000_train)){
  for (i in 1:nrow(atp_players_2000_train)){
...
pdf("M3_GS_clay_p_ij_gelman_plots.pdf")
#par(mfrow = c(3,3))
for (t in 1:nrow(atp_matches_2000_train)){
...
save(BIC,file = "M3_GS_clay_BIC.RData")

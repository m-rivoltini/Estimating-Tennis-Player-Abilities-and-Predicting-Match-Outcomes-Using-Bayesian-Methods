#This script file performs the predictions for out-of-sample matches for M2 on grass surface (Grand Slam Tour)
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Predictions/gorgi_noreg_nosurf/grand_slam/grand_slam_grass")
...
#loading the outputs of the M2_GS_grass
load("/Volumes/SanDisk SSD/Model_fitting_V2/gorgi_noreg_nosurf/grand_slam/grand_slam_grass/gorgi_no_reg_nosurf_GS_grass_with_extra_burnin.RData")

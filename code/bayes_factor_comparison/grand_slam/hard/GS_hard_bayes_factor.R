#======== This script file calculates the Bayes Factor for the hard surface in Grand Slam Tour data set =========
...
#loading M1
load("~/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Analysing_model_fit_outputs/fixed_time_bt/grand_slam/grand_slam_hard/M1_GS_hard_BIC.RData")
M1_BIC <- BIC

#loading M2
load("~/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Analysing_model_fit_outputs/gorgi_noreg_nosurf/grand_slam/grand_slam_hard/M2_GS_hard_BIC.RData")
M2_BIC <- BIC

#loading M3
load("~/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Analysing_model_fit_outputs/Fit_Prediction/Fit/M3_GS_hard/M3_GS_hard_pbhat_BIC.RData")
M3_BIC <- BIC

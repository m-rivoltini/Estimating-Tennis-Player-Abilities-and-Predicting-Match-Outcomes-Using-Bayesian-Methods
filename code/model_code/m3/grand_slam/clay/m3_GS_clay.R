#========== This script file runs M3 on the clay data set for the Grand Slam Tour ==========

#clearing environment and setting working directory
rm(list=ls())
setwd("~/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/gorgi_reg_nosurf/grand_slam/grand_slam_clay")
...
#Importing data
atp_matches_2000 <- read.csv2("atp_matches_2000_train_GS_clay.csv",header = TRUE)
atp_players_2000 <- read.csv2("atp_players_2000_train_GS_clay.csv",header = TRUE)
...
#saving outputs
save(out,model.data,run_time,file = "gorgi_model_reg_nosurf_output_GS_clay_stand_pred_noht_noage_out.RData")
...
for (i in 1:8){
  ...
  save(out,model.data,file = "gorgi_reg_nosurf_GS_clay_with_extra_burnin_stand_pred_noht_noage.RData")
  print(i)
}
t21 <- Sys.time()
run_time_2 <- t21-t11
save(out,model.data,run_time_2,file = "gorgi_reg_nosurf_GS_clay_with_extra_burnin_stand_pred_noht_noage.RData")
#===========================================================================================================

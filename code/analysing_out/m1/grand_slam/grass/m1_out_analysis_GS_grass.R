#=========== Analysing the output of M1 fitted on the Grand Slam tour for the grass surface ===========
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Analysing_model_fit_outputs/fixed_time_bt/grand_slam/grand_slam_grass")

#loading all files and getting computation times for each run
load(file = "/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_grass/BT_fixed_time_out_GS_grass.RData")
run_time

load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_grass/BT_fixed_time_out_GS_grass_with_extra_burnin_small_iter_no_thin.RData")
run_time_2

load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_grass/BT_fixed_time_out_GS_grass_with_extra_burnin.RData")
run_time_2

load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_grass/BT_fixed_time_out_GS_grass_with_extra_burnin_2.RData")
run_time_2

load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_grass/BT_fixed_time_out_GS_grass_with_extra_burnin_3.RData")
run_time_2

load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_grass/BT_fixed_time_out_GS_grass_with_extra_burnin_4.RData")
run_time_2

load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_grass/BT_fixed_time_out_GS_grass_with_extra_burnin_5.RData")
run_time_2

load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_grass/BT_fixed_time_out_GS_grass_with_extra_burnin_6.RData")
run_time_2

load("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_grass/BT_fixed_time_out_GS_grass_with_extra_burnin_7.RData")
run_time_2

#loading the data sets
atp_matches_2000 <- read.csv2("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_grass/atp_matches_2000_train_GS_grass.csv")

atp_players_2000 <- read.csv2("/Users/mishayelrivoltini/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Model_fitting_home_computer/fixed_time_bt/grand_slam/grand_slam_grass/atp_players_2000_train_GS_grass.csv")
...
summaries$names <- player_names_opponents #appending the player names and match-ups
summaries <- subset(summaries,select = c("names","mean","sd","2.5%","97.5%","Rhat","n.eff")) #ordering the columns

#saving the summaries
write.csv(summaries,file = "BT_GS_clay_summaries.csv")
...
top_15_lambda_names <- mat.or.vec(length(top_15_players_ID),1) #saving the variable names lambda[i] for i= top player IDs
...
pdf("M1_GS_grass_lambda_trace_plots.pdf")
par(mfrow = c(3,1))
...
pdf("M1_GS_grass_lambda_density_plots.pdf")
par(mfrow = c(3,3))
for (i in 1:nrow(atp_players_2000)){
...
pdf("M1_GS_grass_p_ij_trace_plots.pdf")
par(mfrow = c(3,1))
...
pdf("M1_GS_grass_p_ij_density_plots.pdf")
par(mfrow = c(3,3))
for (i in 1:nrow(atp_matches_2000)){
...
pdf("M1_GS_grass_lambda_acf_plots.pdf")
par(mfrow = c(3,3))
for (i in 1:nrow(atp_players_2000)){
...
pdf("M1_GS_grass_p_ij_acf_plots.pdf")
par(mfrow = c(3,3))
for (i in 1:nrow(atp_matches_2000)){
...
pdf("M1_GS_grass_lambda_gelman_plots.pdf")
#par(mfrow = c(3,3))
for (i in 1:nrow(atp_players_2000)){
...
pdf("M1_GS_grass_p_ij_gelman_plots.pdf")
#par(mfrow = c(3,3))
for (i in 1:nrow(atp_matches_2000)){
...
chi_disc <- function(y, p) {
  # Perturb p values that are 0 or 1 to avoid division by 0

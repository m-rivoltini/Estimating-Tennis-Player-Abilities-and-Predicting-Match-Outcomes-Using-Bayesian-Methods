#This script file performs the predictions for out-of-sample matches for M1 on all surfaces (Masters Tour)
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Uni Docs/Dissertation/R code/Predictions/fixed_time_bt/master/master_allsurf")

#loading data sets
atp_matches_2000_train <- read.csv2(file = "atp_matches_2000_train_MS_allsurf.csv",header = TRUE)
atp_players_2000_train <- read.csv2(file = "atp_players_2000_train_MS_allsurf.csv",header = TRUE)
...
atp_matches_2000_train_test <- read.csv2(file = "atp_matches_2000_train_test_MS_allsurf.csv",header = TRUE)
atp_players_2000_train_test <- read.csv2(file = "atp_players_2000_train_test_MS_allsurf.csv",header = TRUE)
...
#loading the outputs of the BT_MS_allsurf
